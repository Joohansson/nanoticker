...
'confirmations', 'block_diff', 'multiplier', 'bwlimits', 'api_time', 'supported', 'peerstat',\
...
class Service(UrlService):
    def __init__(self, configuration=None, name=None):
        ...
        self.url = self.configuration.get('url', 'https://json.nanoticker.info/?file=stats-beta')
        self.order = ORDER
