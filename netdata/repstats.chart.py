...
class Service(UrlService):
    def __init__(self, configuration=None, name=None):
        ...
        self.bps_max_old_pr = deque([0]*40) #tps history last 20 polls, init with 20 zeroes
        self.bps_median_old_pr = deque([0]*40) #tps history last 20 polls, init with 20 zeroes
        self.cemented_max_old_pr = 0 #cemented count previous poll
        self.cemented_median_old_pr = 0 #cemented count previous poll
        self.cps_max_old_pr = deque([0]*40) #cps history last 20 polls, init with 20 zeroes
        self.cps_median_old_pr = deque([0]*40) #cps history last 20 polls, init with 20 zeroes
